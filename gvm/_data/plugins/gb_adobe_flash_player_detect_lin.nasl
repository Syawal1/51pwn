...
flashName = ssh_find_file(file_name:"/libflashplayer.so", useregex:TRUE, regexpar:"$", sock:air_sock);
if(flashName){
...
airPaths = ssh_find_file(file_name:"/ApolloVersion", useregex:TRUE, regexpar:"$", sock:air_sock);
if(!airPaths){
