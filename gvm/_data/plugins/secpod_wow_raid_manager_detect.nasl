...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script detects the installed version of WOW Raid Manager.");
...
foreach dir( make_list_unique( "/wrm", http_cgi_dirs( port:port ) ) ) {
  ...
  if( rcvRes =~ "^HTTP/1\.[01] 200" && "WoW Raid Manager" >< rcvRes ) {
