...
paths = ssh_find_bin(prog_name:"openssl", sock:sock);
foreach executableFile(paths) {
  ...
  vers = ssh_get_bin_version(full_prog_name:executableFile, sock:sock, version_argv:"version", ver_pattern:"OpenSSL ([0-9.a-z\-]+)");
  if(vers[1]) {
