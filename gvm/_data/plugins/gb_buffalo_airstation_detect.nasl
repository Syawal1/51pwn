...
if(description)
{
  ...
  script_version("2020-09-02T09:42:47+0000");
  script_tag(name:"last_modification", value:"2020-09-02 09:42:47 +0000 (Wed, 02 Sep 2020)");
...
if ('name="airstation_uname"' >< res && 'alt="BUFFALO"' >< res) {
  ...
  register_and_report_os(os: "Buffalo Airstation Firmware", cpe: cpe, desc: "Buffalo AirStation Detection (HTTP)", runs_key: "unixoide");
