...
if(description)
{
  ...
  script_version("2020-11-24T09:37:08+0000");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-11-24 09:37:08 +0000 (Tue, 24 Nov 2020)");
    ...
    if( c == 3 ) {
      ...
      if( os_str && ! isnull( os_str ) ) {
        ...
        # SMB String: CIFS 4.32
          ...
          register_and_report_os( os:"Apple Base Station Firmware", cpe:"cpe:/o:apple:base_station_firmware", banner_type:banner_type, port:port, banner:banner, desc:SCRIPT_DESC, runs_key:"unixoide" );
        }
        ...
        # SMB String: Samba 3.6.23-53.el6_10
          ...
          if( ! isnull( version[1] ) ) {
            register_and_report_os( os:"Red Hat Enterprise Linux / CentOS", version:version[1], cpe:"cpe:/o:redhat:enterprise_linux", banner_type:banner_type, port:port, banner:banner, desc:SCRIPT_DESC, runs_key:"unixoide" );
          } else {
            register_and_report_os( os:"Red Hat Enterprise Linux / CentOS", cpe:"cpe:/o:redhat:enterprise_linux", banner_type:banner_type, port:port, banner:banner, desc:SCRIPT_DESC, runs_key:"unixoide" );
          }
        }
        ...
        # nb: Note the comments about some Linux/Unix SMB installations reporting a "Windows String"
          ...
          if( "windows 10 " >< os_str_lo ) {
            ...
            register_and_report_os( os:os_str, version:ver, cpe:cpe, full_cpe:TRUE, banner_type:banner_type, port:port, banner:banner, desc:SCRIPT_DESC, runs_key:"windows" );
          }
