...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://docs.greenbone.net/GSM-Manual/gos-4/en/compliance.html#oval-system-characteristics");
  script_xref(name:"URL", value:"https://docs.greenbone.net/GSM-Manual/gos-5/en/compliance-and-special-scans.html#running-an-oval-system-characteristics-scan");
  script_xref(name:"URL", value:"https://docs.greenbone.net/GSM-Manual/gos-6/en/compliance-and-special-scans.html#running-an-oval-system-characteristics-scan");
