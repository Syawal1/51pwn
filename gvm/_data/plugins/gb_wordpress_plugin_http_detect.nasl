...
if(description)
{
  ...
  script_tag(name:"last_modification", value:"2020-10-27 09:39:13 +0000 (Tue, 27 Oct 2020)");
  ...
  script_tag(name:"summary", value:"Checks and reports which WordPress plugins are installed on the target system.");
...
#nb: The format is: "[README_URL]", "[NAME]#---#[DETECTION PATTERN]#---#[VERSION REGEX]#---#[CPE]#---#[CHANGELOG REGEX (optional)]"
plugins = make_array(
...
"accordions/readme.txt", "Accordion#---#=== Accordion#---#Stable tag: ([0-9.]+)#---#cpe:/a:pickplugins:accordions",
...
"advanced-access-manager/readme.txt", "Advanced Access Manager#---#=== Advanced Access Manager ===#---#Stable tag: ([0-9.]+)#---#cpe:/a:vasyltech:advanced-access-manager",
...
"advanced-woo-search/readme.txt", "Advanced Woo Search#---#=== Advanced Woo Search ===#---#Stable tag: ([0-9.]+)#---#cpe:/a:illid:advanced-woo-search",
...
"all-in-one-seo-pack/readme.txt", "All in One SEO Pack#---#=== All in One SEO Pack ===#---#Stable tag: (trunk|[0-9.]+)#---#cpe:/a:semperplugins:all-in-one-seo-pack",
...
"autoptimize/readme.txt", "Autoptimize#---#=== Autoptimize ===#---#Stable tag: ([0-9.]+)#---#cpe:/a:futtta:autoptimize",
...
"contact-form-7-datepicker/readme.txt", "Contact Form 7 Datepicker#---#(Datepicker for Contact Form 7|Easily add a date field using jQuery UI's datepicker to your CF7 forms)#---#Stable tag: ([0-9.]+)#---#cpe:/a:relu:contact-form-7-datepicker",
...
"cookie-law-info/readme.txt", "GDPR Cookie Consent#---#Cookie Law#---#Stable tag: ([0-9.]+)#---#cpe:/a:webtoffee:cookie-law-info",
...
"data-tables-generator-by-supsystic/readme.txt", "Data Tables Generator by Supsystic#---#=== Data Tables Generator#---#Stable tag: ([0-9.]+)#---#cpe:/a:supsystic:data-tables-generator-by-supsystic",
...
"drag-and-drop-multiple-file-upload-contact-form-7/readme.txt", "Drag and Drop Multiple File Upload - Contact Form 7#---#=== Drag and Drop Multiple File Upload#---#Stable tag: ([0-9.]+)#---#cpe:/a:codedropz:drag-and-drop-multiple-file-upload-contact-form-7",
...
"elementor/readme.txt", "Elementor Page Builder#---#=== Elementor#---#Stable tag: ([0-9.]+)#---#cpe:/a:elementor:elementor_page_builder",
...
"envira-gallery-lite/readme.txt", "Envira Photo Gallery#---#Envira Gallery#---#== Changelog(.*)#---#cpe:/a:enviragallery:photo_gallery#---#=? ?([0-9.]+)",
...
"fv-wordpress-flowplayer/readme.txt", "FV Flowplayer Video Player#---#=== (Flowplayer|FV) (Wordpress|Flowplayer)#---#== Changelog(.*)#---#cpe:/a:foliovision:fv-wordpress-flowplayer#---#= ([0-9.]+)",
...
"gtranslate/readme.txt", "GTranslate#---#=== GTranslate#---#Stable tag: ([0-9.]+)#---#cpe:/a:gtranslate:gtranslate",
...
"iframe/readme.txt", "iframe#---#=== iframe ===#---#Stable tag: ([0-9.]+)#---#cpe:/a:webvitaly:iframe",
...
"lara-google-analytics/readme.txt", "Lara's Google Analytics#---#===( Lara's)? Google Analytics (By Lara )?===#---#Stable tag: ([0-9.]+)#---#cpe:/a:xtraorbit:lara-google-analytics",
...
"mappress-google-maps-for-wordpress/readme.txt", "MapPress Maps for WordPress#---#=== MapPress#---#Stable tag: ([0-9.]+)#---#cpe:/a:chrisvrichardson:mappress-google-maps-for-wordpress",
...
"modern-events-calendar-lite/readme.txt", "Modern Events Calendar Lite#---#=== Modern Events Calendar Lite ===#---#Stable tag: ([0-9.]+)#---#cpe:/a:webnus:modern-events-calendar-lite",
...
"popup-builder/readme.txt", "Popup Builder#---#Popup Builder#---#== Changelog(.*)#---#cpe:/a:sygnoos:popup-builder#---#Version ([0-9.]+)",
...
"quiz-master-next/readme.txt", "Quiz And Survey Master#---#=== (Quiz Master Next|Quiz And Survey Master)#---#Stable tag: ([0-9.]+)#---#cpe:/a:expresstech:quiz-master-next",
"real-time-find-and-replace/readme.txt", "Real-Time Find and Replace#---#=== Real-Time Find and Replace#---#== Changelog(.*)#---#cpe:/a:infolific:real-time-find-and-replace#---#= ([0-9.]+) =",
"relevanssi/readme.txt", "Relevanssi#---#Relevanssi - A Better Search#---#Stable tag: ([0-9.]+)#---#cpe:/a:mikkosaari:relevanssi",
"responsive-add-ons/readme.txt", "Gutenberg & Elementor Templates Importer For Responsive#---#(Gutenberg & Elementor Templates Importer For Responsive|Responsive Ready Sites Importer|Adds Google, Yahoo and Bing verification codes and adds Site Statistics scripts to your site)#---#Stable tag: ([0-9.]+)#---#cpe:/a:cyberchimps:responsive-add-ons",
...
"simple-membership/readme.txt", "Simple Membership#---#=== Simple Membership#---#Stable tag: ([0-9.]+)#---#cpe:/a:wp_insider:simple-membership",
...
"tc-custom-javascript/readme.txt", "TC Custom JavaScript#---#=== TC Custom JavaScript ===#---#Stable tag: ([0-9.]+)#---#cpe:/a:tinycode:tc-custom-javascript",
...
"themegrill-demo-importer/readme.txt", "ThemeGrill Demo Importer#---#=== ThemeGrill Demo Importer ===#---#Stable tag: ([0-9.]+)#---#cpe:/a:themegrill:themegrill-demo-importer",
"testimonial-rotator/readme.txt", "Testimonial Rotator#---#Easily add (Testimonials to your WordPress Blog|and manage Testimonials to your site\.)#---#== Changelog(.*)#---#cpe:/a:halgatewood:testimonial_rotator#---#= ([0-9.]+) [-=]",
...
"users-customers-import-export-for-wp-woocommerce/readme.txt", "Import Export WordPress Users#---#(WordPress Users & WooCommerce Customers Import Export|Import Export WordPress Users)#---#Stable tag: ([0-9.]+)#---#cpe:/a:webtoffee:users-customers-import-export-for-wp-woocommerce",
...
"wp-google-map-plugin/readme.txt", "WP Google Map Plugin#---#(WP Google Map Plugin|flippercode)#---#== Changelog(.*)#---#cpe:/a:flippercode:wp-google-map-plugin#---#= ([0-9.]+) =",
"wp-google-maps/readme.txt", "WP Google Maps#---#=== WP Google Maps ===#---#== Changelog(.*)#---#cpe:/a:wpgmaps:wp-google-maps#---#[=*] ([0-9.]+)",
...
"wpforms-lite/readme.txt", "WPForms Contact Form#---#(WPForms Lite ===|=== Contact Form by WPForms)#---#= ([0-9.]+) =#---#cpe:/a:wpforms:wpforms-lite",
...
foreach readme( keys( plugins ) ) {
  ...
  if( egrep( pattern: detect_regex, string: res, icase: TRUE ) && ( "Changelog" >< res || res =~ "Tested up to: ([0-9.]+)" ) ) {
