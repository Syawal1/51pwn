...
if(description)
{
  ...
  script_version("2020-11-06T08:10:45+0000");
  script_tag(name:"last_modification", value:"2020-11-06 08:10:45 +0000 (Fri, 06 Nov 2020)");
  ...
  script_add_preference(name:"Folder exclusion regex for file search on Unixoide targets", type:"entry", value:"^/(afs|dev|media|mnt|net|run|sfs|sys|tmp|udev|var|etc/init\.d|usr/share/doc)", id:10);
...
if( unix_search_excl ) {
  ...
  set_kb_item( name:"ssh/lsc/search_exclude_paths", value:"^/(afs|dev|media|mnt|net|run|sfs|sys|tmp|udev|var|etc/init\.d|usr/share/doc)" );
}
