...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for libxslt (DLA-1756-1)");
  ...
  package(s) announced via the DLA-1756-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was an authentication bypass
