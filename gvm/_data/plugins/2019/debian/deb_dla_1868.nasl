...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for squirrelmail (DLA-1868-1)");
  ...
  package(s) announced via the DLA-1868-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An XSS vulnerability was discovered in SquirrelMail. Due to improper
