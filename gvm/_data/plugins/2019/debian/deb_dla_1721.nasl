...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for otrs2 (DLA-1721-1)");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"otrs", ver:"3.3.18-1+deb8u8", rls:"DEB8"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"otrs2", ver:"3.3.18-1+deb8u8", rls:"DEB8"))) {
  report += res;
}
