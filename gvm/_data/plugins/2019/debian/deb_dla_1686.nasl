...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for freedink-dfarc (DLA-1686-1)");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"freedink-dfarc", ver:"3.12-1+deb8u1", rls:"DEB8"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"freedink-dfarc-dbg", ver:"3.12-1+deb8u1", rls:"DEB8"))) {
  report += res;
}
