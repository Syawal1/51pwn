...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for python3.4 (DLA-1852-1)");
  ...
  package(s) announced via the DLA-1852-1 advisory.");
...
This update also fixes another regression introduced in the update
