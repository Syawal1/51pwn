...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for uriparser (DLA-1682-1)");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"liburiparser-dev", ver:"0.8.0.1-2+deb8u2", rls:"DEB8"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"liburiparser1", ver:"0.8.0.1-2+deb8u2", rls:"DEB8"))) {
  report += res;
}
