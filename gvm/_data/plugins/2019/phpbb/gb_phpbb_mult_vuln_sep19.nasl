...
if(description)
{
  ...
  script_name("phpBB < 3.2.8 Multiple Vulnerabilities");
  ...
  script_tag(name:"affected", value:"phpBB version before 3.2.8.");
  ...
  script_xref(name:"URL", value:"https://tracker.phpbb.com/issues/?filter=15090");
