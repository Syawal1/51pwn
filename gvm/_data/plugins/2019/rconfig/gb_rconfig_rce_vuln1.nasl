...
if (description)
{
  ...
  script_version("2020-11-04T10:59:55+0000");
  script_tag(name:"last_modification", value:"2020-11-04 10:59:55 +0000 (Wed, 04 Nov 2020)");
  ...
  script_tag(name:"summary", value:"rConfig is prone to an unauthenticated remote code execution (RCE) vulnerability in
