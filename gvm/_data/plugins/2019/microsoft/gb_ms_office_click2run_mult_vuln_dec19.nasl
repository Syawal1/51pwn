...
if(description)
{
  ...
  - Multiple errors in Microsoft Access because it fails to properly handle objects in memory.

  - An error in Microsoft Word because it fails to properly handle objects in memory.
