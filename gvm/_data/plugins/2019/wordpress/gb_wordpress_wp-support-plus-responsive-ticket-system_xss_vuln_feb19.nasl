...
if (description)
{
  ...
  script_mandatory_keys("wordpress/plugin/wp-support-plus-responsive-ticket-system/detected");
...
CPE = "cpe:/a:pradeep_makone:wp-support-plus-responsive-ticket-system";
