...
if (description)
{
  ...
  script_name("WordPress Import any XML or CSV File to WordPress Plugin All Versions Multiple XSS Vulnerabilities");
  ...
  script_tag(name:"affected", value:"WordPress Import any XML or CSV File to WordPress plugin all versions.");
...
CPE = "cpe:/a:soflyy:wp-all-import";
