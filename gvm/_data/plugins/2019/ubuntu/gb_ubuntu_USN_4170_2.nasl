...
if(release == "UBUNTU19.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libwhoopsie0", ver:"0.2.66ubuntu0.2", rls:"UBUNTU19.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"whoopsie", ver:"0.2.66ubuntu0.2", rls:"UBUNTU19.10"))) {
    report += res;
  }
