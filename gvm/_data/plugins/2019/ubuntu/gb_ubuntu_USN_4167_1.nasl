...
if(release == "UBUNTU19.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsmbclient", ver:"2:4.10.7+dfsg-0ubuntu2.2", rls:"UBUNTU19.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"samba", ver:"2:4.10.7+dfsg-0ubuntu2.2", rls:"UBUNTU19.10"))) {
    report += res;
  }
