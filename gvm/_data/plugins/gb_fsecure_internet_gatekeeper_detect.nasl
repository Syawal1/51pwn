...
register_and_report_os( os:"Linux", cpe:"cpe:/o:linux:kernel", port:port, desc:"F-Secure Internet Gatekeeper Detection (HTTP)", runs_key:"unixoide" );
...
log_message(data: build_detection_report(app: "F-Secure Internet Gatekeeper", version: vers, install: install,
                                         cpe: cpe, concluded: version[0], concludedUrl: url),
            port: port);
