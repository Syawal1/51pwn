...
if(description)
{
  ...
  script_version("2020-11-12T10:39:12+0000");
  script_tag(name:"last_modification", value:"2020-11-12 10:39:12 +0000 (Thu, 12 Nov 2020)");
  ...
  script_dependencies("apache_SSL_complain.nasl",
                      ...
                      "gb_apache_jserv_ajp_detect.nasl", "gb_apache_zookeeper_detect.nasl",
                      ...
                      "gb_emc_networker_detect.nasl", "gb_ethernetip_tcp_detect.nasl",
                      ...
                      "gb_qotd_detect_tcp.nasl",
                      "gb_redis_detect.nasl", "gb_riak_detect.nasl",
                      "gb_rlogin_detect.nasl",
                      ...
                      "ssh_detect.nasl", "swat_detect.nasl", "sw_jenkins_detect.nasl",
  ...
  if(FEED_NAME == "GSF" || FEED_NAME == "SCM")
    script_dependencies("gsf/gb_sap_gateway_detect.nasl", "gsf/gb_atg_service_detect.nasl",
                        ...
                        "gsf/gb_ethernetip_udp_detect.nasl", "gsf/gb_nimbus_detect.nasl");
...
function unknown_banner_report( port ) {
  ...
  foreach method( make_list( "spontaneousHex", "spontaneous", "get_httpHex", "get_http", "helpHex", "help", "xmlHex", "xml", "jsonHex", "json", "sipHex", "sip", "binHex", "bin" ) ) {
