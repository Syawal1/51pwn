...
if(description)
{
  ...
  script_version("2020-07-30T15:42:53+0000");
  script_tag(name:"last_modification", value:"2020-07-30 15:42:53 +0000 (Thu, 30 Jul 2020)");
...
foreach key( key_list ) {
  foreach item( registry_enum_keys( key:key ) ) {
    ...
    if( ! appName || appName !~ "Schneider Electric Software Update" )
      continue;
    ...
    set_kb_item( name:"schneider_electric/software_update_utility/detected", value:TRUE );

    register_and_report_cpe( app:appName, ver:version, concluded:concluded,
                             base:"cpe:/a:schneider_electric:software_update_utility:", expr:"^([0-9.]+)", insloc:location, regService:"smb-login", regPort:0 );
    exit( 0 );
  }
}
