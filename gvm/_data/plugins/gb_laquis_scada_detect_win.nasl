...
if(description)
{
  ...
  script_version("2020-10-14T13:19:33+0000");
  script_tag(name:"last_modification", value:"2020-10-14 13:19:33 +0000 (Wed, 14 Oct 2020)");
  ...
  script_tag(name:"summary", value:"SMB login based detection of LCDS LAquis SCADA for Windows.");
...
foreach key( key_list ) {
  foreach item( registry_enum_keys( key:key ) ) {
    ...
    if( ! appName || appName !~ "SCADA LAquis" )
      continue;
