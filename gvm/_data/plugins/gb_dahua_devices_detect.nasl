  ...
  )
{
  ...
  register_and_report_os( os:"Linux/Unix (Embedded)", cpe:"cpe:/o:linux:kernel", banner_type:"Dahua Web Service", port:port, desc:"Dahua Devices Detection", runs_key:"unixoide" );
