...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script finds the installed OpenMairie products version.");
...
if (!http_can_host_php(port:openPort)) exit(0);
...
"/openmairie_cimetiere", "/Openmairie_Cimetiere", "/", http_cgi_dirs(port:openPort));
...
foreach dir (make_list_unique("/openmairie_catalogue", "/Openmairie_Catalogue", http_cgi_dirs(port:openPort)))
{
