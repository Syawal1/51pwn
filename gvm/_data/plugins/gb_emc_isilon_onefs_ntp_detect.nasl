...
if(description)
{
  ...
  script_name("Dell EMC Isilon OneFS Devices Detection (NTP)");

  script_tag(name:"summary", value:"This script performs an NTP based detection of Dell EMC Isilon OneFS devices.");
