...
if( hexstr( recv ) =~ "^0000000400000000000000040000000400000001$" ) {
  ...
  register_and_report_os( os: "Cisco IOS", cpe: "cpe:/o:cisco:ios", banner_type: "Cisco SMI protocol", port: port, desc: "Cisco Smart Install Protocol Detection", runs_key: "unixoide" );
