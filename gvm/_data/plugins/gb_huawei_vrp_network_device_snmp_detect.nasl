...
if (description)
{
  ...
  script_version("2020-05-26T11:04:18+0000");
  script_tag(name:"last_modification", value:"2020-05-26 11:04:18 +0000 (Tue, 26 May 2020)");
      ...
      if (!isnull(mo[1]))
        ...
        if (!isnull(mo[1]))
          ...
          if (!isnull(mo[1]))
            ...
            # Software Version: VRP (R) Software, Version 3.30 Eudemon 1000E V100R002C01SPC200
