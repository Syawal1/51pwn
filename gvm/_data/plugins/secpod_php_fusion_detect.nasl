...
if(description)
{
  ...
  script_name("PHP-Fusion Detection (HTTP)");
...
foreach dir( make_list_unique( "/", "/php-fusion", "/phpfusion", http_cgi_dirs( port:port ) ) ) {
  ...
  foreach files( make_list( "/home.php", "/news.php" ) ) {
    ...
    if( "X-Powered-By: PHP-Fusion" >< res || "PHP-Fusion Powered" >< res ||
        res =~ ">Powered by <a href='https?://(www\.)?php-fusion\.co\.uk'>PHP-Fusion</a>" ) {
      version = "unknown";
      ...
      log_message( data:build_detection_report( app:"PHP-Fusion", version:version, install:install, cpe:cpe,
