...
if( test_alive_hosts_only && "yes" >< test_alive_hosts_only ) {
  if( "yes" >< report_up )
    log_message( data:"Host is up, Method: Boreas Host Alive Scanner" );
...
if( "yes" >< report_dead ) {
  ...
  log_message( data:"The remote host " + targetip + ' was considered as dead.' + report_dead_methods, port:0 );
}
