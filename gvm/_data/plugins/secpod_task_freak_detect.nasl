...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script finds the installed Task Freak version.");
...
foreach dir( make_list_unique( "/taskfreak", "/Taskfreak", "/", http_cgi_dirs( port:port ) ) ) {
  ...
  if( rcvRes =~ "^HTTP/1\.[01] 200" && ">TaskFreak! multi user<" >< rcvRes ) {
