...
if(description)
{
  ...
  script_tag(name:"last_modification", value:"2020-09-08 07:35:48 +0000 (Tue, 08 Sep 2020)");
...
if( "220 KONICA MINOLTA FTP server ready." >< banner ) {
  register_and_report_os( os:"KONICA MINOLTA Printer Firmware", cpe:"cpe:/o:konicaminolta:printer_firmware", banner_type:BANNER_TYPE, port:port, banner:banner, desc:SCRIPT_DESC, runs_key:"unixoide" );
  exit( 0 );
}

if( banner =~ "220[- ](AXIS|Axis).*Network Camera" ) {
  register_and_report_os( os:"Axis Network Camera Firmware", cpe:"cpe:/o:axis:network_camera_firmware", banner_type:BANNER_TYPE, port:port, banner:banner, desc:SCRIPT_DESC, runs_key:"unixoide" );
  exit( 0 );
}
...
if( "Welcome to Linksys" >< banner ) {
  register_and_report_os( os:"Linksys Device Firmware", cpe:"cpe:/o:linksys:device_firmware", banner_type:BANNER_TYPE, port:port, banner:banner, desc:SCRIPT_DESC, runs_key:"unixoide" );
  exit( 0 );
}
