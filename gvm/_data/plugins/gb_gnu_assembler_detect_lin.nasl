...
if(description)
{
  ...
  script_version("2020-08-20T14:18:28+0000");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-08-20 14:18:28 +0000 (Thu, 20 Aug 2020)");
...
binary_list = ssh_find_file( file_name:"/as", useregex:TRUE, regexpar:"$", sock:sock );
if( ! binary_list ) {
