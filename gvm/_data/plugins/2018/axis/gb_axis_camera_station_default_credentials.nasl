...
if(description)
{
  ...
  script_dependencies("gb_axis_camera_station_detect.nasl", "gb_default_credentials_options.nasl");
...
foreach cred(keys(creds)) {
  ...
  req1 = http_post_put_req(port: port, url: url, data: data, add_headers: make_array("Accept-Encoding", "gzip, deflate",
  ...
  req2 = http_post_put_req(port: port, url: url, data: data, add_headers: make_array("Accept-Encoding", "gzip, deflate",
                                                                                 "Content-Type", "application/json; charset=utf-8",
                                                                                 "Axis-Orig-Sw", "true",
                                                                                 "X-Requested-With", "XMLHttpRequest",
                                                                                 "Authorization", auth));
