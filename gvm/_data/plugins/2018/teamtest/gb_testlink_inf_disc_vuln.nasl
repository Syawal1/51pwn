...
if( description )
{
  ...
  script_tag(name:"vuldetect", value:"The script tries to exploit the vulnerability and reports the vulnerability
  in case of success.");

  script_tag(name:"insight", value:"TestLink allows remote attackers to read arbitrary attachments via a modified
  ID field to /lib/attachments/attachmentdownload.php.");
