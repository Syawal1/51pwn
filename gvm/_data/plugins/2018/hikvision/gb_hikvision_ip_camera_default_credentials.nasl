...
if(description)
{
  ...
  script_dependencies("gb_hikvision_ip_camera_detect.nasl", "gb_default_credentials_options.nasl");
...
foreach cred(keys(creds)) {
  ...
  if("<challenge>" >< res1 && "<iterations>" >< res1) {
    ...
    req2 = http_post_put_req(port: port, url: url3, data: data, add_headers: make_array("Accept-Encoding", "gzip, deflate",
                                                                                    "If-Modified-Since", "0",
