...
if(description)
{
  ...
  script_version("2020-11-27T08:42:41+0000");
  script_tag(name:"last_modification", value:"2020-11-27 08:42:41 +0000 (Fri, 27 Nov 2020)");
  ...
  script_dependencies("secpod_wordpress_detect_900182.nasl", "drupal_detect.nasl", "gb_prestashop_detect.nasl",
  ...
  script_tag(name:"insight", value:"The flaw exists because Util/PHP/eval-stdin.php in PHPUnit allows
...
# nb: ownCloud itself isn't affected, have only seen this single 3rdparty app shipping phpunit
...
# To additional check  the file in every detected directories.
"/eval-stdin.php" );

#nb: The final list with the directories from webmirror.nasl and DDI_Directory_Scanner.nasl.
foreach dir( make_list( "/", http_cgi_dirs( port:port ) ) ) {
  if( dir == "/" ) dir = "";
  foreach file( files ) {
