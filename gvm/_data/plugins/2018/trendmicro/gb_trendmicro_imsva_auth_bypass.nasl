...
if(description)
{
  ...
  script_version("2020-11-09T08:04:49+0000");
  script_tag(name:"last_modification", value:"2020-11-09 08:04:49 +0000 (Mon, 09 Nov 2020)");
...
if((version == "9.1") && (version_is_less(version:build, test_version:"1682"))) {
  report = report_fixed_ver(installed_version:version, installed_build:build,
                            fixed_version:"9.1", fixed_build:"1682");
  Vuln = TRUE;
} else if ((version == "9.0") && (version_is_less(version:build, test_version:"1653"))) {
  report = report_fixed_ver(installed_version:version, installed_build:build,
                            fixed_version:"9.0", fixed_build:"1653");
  Vuln = TRUE;
}
if (Vuln) {
