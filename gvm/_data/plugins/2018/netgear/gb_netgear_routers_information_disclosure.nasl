...
if(description)
{
  ...
  script_tag(name:"insight", value:"When the request is processed, it exposes the admin's password in clear text before
  it gets redirected to absw_vfysucc.cgia.");
...
cpe_list = make_list( "cpe:/h:netgear:dgn2200", "cpe:/h:netgear:dgnd3700" );
