...
if( description )
{
  ...
  script_tag(name:"summary", value:"The script checks if the target host runs End of Life software.
  End of Life software doesn't receive any more updates and is highly prone to zero-day vulnerabilities.");
