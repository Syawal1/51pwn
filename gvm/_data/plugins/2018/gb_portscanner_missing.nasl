...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://docs.greenbone.net/GSM-Manual/gos-4/en/performance.html#scan-performance");
  script_xref(name:"URL", value:"https://docs.greenbone.net/GSM-Manual/gos-4/en/vulnerabilitymanagement.html?highlight=scanner_plugins_timeout#general-preferences");
  script_xref(name:"URL", value:"https://docs.greenbone.net/GSM-Manual/gos-5/en/performance.html#optimizing-the-scan-performance");
  script_xref(name:"URL", value:"https://docs.greenbone.net/GSM-Manual/gos-5/en/scanning.html?highlight=scanner_plugins_timeout#preference-description");
  script_xref(name:"URL", value:"https://docs.greenbone.net/GSM-Manual/gos-6/en/performance.html#optimizing-the-scan-performance");
  script_xref(name:"URL", value:"https://docs.greenbone.net/GSM-Manual/gos-6/en/scanning.html?highlight=scanner_plugins_timeout#preference-description");
