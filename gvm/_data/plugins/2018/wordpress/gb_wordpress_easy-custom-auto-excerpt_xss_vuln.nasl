...
if (description)
{
  ...
  script_mandatory_keys("wordpress/plugin/easy-custom-auto-excerpt/detected");
...
CPE = "cpe:/a:tonjoo:easy-custom-auto-excerpt";
...
if ( version_is_less_equal( version: version, test_version: "2.4.6" )) {
