...
if (description)
{
  ...
  script_mandatory_keys("wordpress/plugin/tabs-responsive/detected");
...
CPE = "cpe:/a:wpshopsmart:tabs-responsive";
...
if ( version_is_less_equal( version: version, test_version: "1.8.0" )) {
