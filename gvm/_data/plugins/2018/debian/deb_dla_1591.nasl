...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for libphp-phpmailer (DLA-1591-1)");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libphp-phpmailer", ver:"5.2.9+dfsg-2+deb8u4", rls:"DEB8"))) {
  report += res;
}
