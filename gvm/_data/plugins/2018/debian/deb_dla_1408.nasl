...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for simplesamlphp (DLA-1408-1)");
...
CVE-2017-12868 was an about an improper fix of CVE-2017-12872 in the
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"simplesamlphp", ver:"1.13.1-2+deb8u2", rls:"DEB8"))) {
  report += res;
}
