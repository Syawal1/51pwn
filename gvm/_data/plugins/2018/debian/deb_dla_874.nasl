...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for jbig2dec (DLA-874-1)");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"jbig2dec", ver:"0.13-4~deb7u1", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libjbig2dec0", ver:"0.13-4~deb7u1", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libjbig2dec0-dev", ver:"0.13-4~deb7u1", rls:"DEB7"))) {
  report += res;
}
