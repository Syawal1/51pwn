...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for libvirt (DLA-1315-1)");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libvirt-bin", ver:"0.9.12.3-1+deb7u3", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libvirt-dev", ver:"0.9.12.3-1+deb7u3", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libvirt-doc", ver:"0.9.12.3-1+deb7u3", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libvirt0", ver:"0.9.12.3-1+deb7u3", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libvirt0-dbg", ver:"0.9.12.3-1+deb7u3", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"python-libvirt", ver:"0.9.12.3-1+deb7u3", rls:"DEB7"))) {
  report += res;
}
