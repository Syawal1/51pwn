...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for rubygems (DLA-1112-1)");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"rubygems", ver:"1.8.24-1+deb7u1", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"rubygems-doc", ver:"1.8.24-1+deb7u1", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"rubygems1.8", ver:"1.8.24-1+deb7u1", rls:"DEB7"))) {
  report += res;
}
