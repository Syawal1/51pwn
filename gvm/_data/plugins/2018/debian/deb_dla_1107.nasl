...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for bzr (DLA-1107-1)");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"bzr", ver:"2.6.0~bzr6526-1+deb7u1", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"bzr-doc", ver:"2.6.0~bzr6526-1+deb7u1", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"python-bzrlib", ver:"2.6.0~bzr6526-1+deb7u1", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"python-bzrlib-dbg", ver:"2.6.0~bzr6526-1+deb7u1", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"python-bzrlib.tests", ver:"2.6.0~bzr6526-1+deb7u1", rls:"DEB7"))) {
  report += res;
}
