...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for libreoffice (DLA-910-1)");
...
if(!isnull(res = isdpkgvuln(pkg:"uno-libs3", ver:"1:3.5.4+dfsg2-0+deb7u9", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"uno-libs3-dbg", ver:"1:3.5.4+dfsg2-0+deb7u9", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"ure", ver:"1:3.5.4+dfsg2-0+deb7u9", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"ure-dbg", ver:"1:3.5.4+dfsg2-0+deb7u9", rls:"DEB7"))) {
  report += res;
}
