...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for libtirpc (DLA-936-1)");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libtirpc-dev", ver:"0.2.2-5+deb7u1", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libtirpc1", ver:"0.2.2-5+deb7u1", rls:"DEB7"))) {
  report += res;
}
