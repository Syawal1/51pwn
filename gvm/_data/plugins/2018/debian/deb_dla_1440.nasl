...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for libarchive-zip-perl (DLA-1440-1)");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libarchive-zip-perl", ver:"1.39-1+deb8u1", rls:"DEB8"))) {
  report += res;
}
