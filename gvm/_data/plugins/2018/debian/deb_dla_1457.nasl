...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for ant (DLA-1457-1)");
  ...
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DLA-1457-1");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"ant", ver:"1.9.4-3+deb8u2", rls:"DEB8"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"ant-doc", ver:"1.9.4-3+deb8u2", rls:"DEB8"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"ant-gcj", ver:"1.9.4-3+deb8u2", rls:"DEB8"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"ant-optional", ver:"1.9.4-3+deb8u2", rls:"DEB8"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"ant-optional-gcj", ver:"1.9.4-3+deb8u2", rls:"DEB8"))) {
  report += res;
}
