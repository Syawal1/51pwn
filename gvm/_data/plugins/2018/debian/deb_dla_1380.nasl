...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for libmad (DLA-1380-1)");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libmad0", ver:"0.15.1b-7+deb7u1", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libmad0-dev", ver:"0.15.1b-7+deb7u1", rls:"DEB7"))) {
  report += res;
}
