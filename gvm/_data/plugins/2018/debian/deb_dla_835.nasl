...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for cakephp (DLA-835-1)");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"cakephp", ver:"1.3.15-1+deb7u2", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"cakephp-scripts", ver:"1.3.15-1+deb7u2", rls:"DEB7"))) {
  report += res;
}
