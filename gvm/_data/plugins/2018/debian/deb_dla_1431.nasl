...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for ant (DLA-1431-1)");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"ant", ver:"1.9.4-3+deb8u1", rls:"DEB8"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"ant-doc", ver:"1.9.4-3+deb8u1", rls:"DEB8"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"ant-gcj", ver:"1.9.4-3+deb8u1", rls:"DEB8"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"ant-optional", ver:"1.9.4-3+deb8u1", rls:"DEB8"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"ant-optional-gcj", ver:"1.9.4-3+deb8u1", rls:"DEB8"))) {
  report += res;
}
