...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for twitter-bootstrap3 (DLA-1479-1)");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libjs-bootstrap", ver:"3.2.0+dfsg-1+deb7u1", rls:"DEB8"))) {
  report += res;
}
