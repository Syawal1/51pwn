...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for libidn (DLA-1084-1)");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"idn", ver:"1.25-2+deb7u3", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libidn11", ver:"1.25-2+deb7u3", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libidn11-dev", ver:"1.25-2+deb7u3", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libidn11-java", ver:"1.25-2+deb7u3", rls:"DEB7"))) {
  report += res;
}
