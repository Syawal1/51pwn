...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for libpdfbox-java (DLA-1547-1)");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"libfontbox-java", ver:"1:1.8.7+dfsg-1+deb8u2", rls:"DEB8"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libfontbox-java-doc", ver:"1:1.8.7+dfsg-1+deb8u2", rls:"DEB8"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libjempbox-java", ver:"1:1.8.7+dfsg-1+deb8u2", rls:"DEB8"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libjempbox-java-doc", ver:"1:1.8.7+dfsg-1+deb8u2", rls:"DEB8"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libpdfbox-java", ver:"1:1.8.7+dfsg-1+deb8u2", rls:"DEB8"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"libpdfbox-java-doc", ver:"1:1.8.7+dfsg-1+deb8u2", rls:"DEB8"))) {
  report += res;
}
