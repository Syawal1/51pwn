...
if(description)
{
  ...
  script_name("Debian LTS: Security Advisory for irssi (DLA-1088-1)");
...
res = "";
report = "";
if(!isnull(res = isdpkgvuln(pkg:"irssi", ver:"0.8.15-5+deb7u2", rls:"DEB7"))) {
  report += res;
}
if(!isnull(res = isdpkgvuln(pkg:"irssi-dev", ver:"0.8.15-5+deb7u2", rls:"DEB7"))) {
  report += res;
}
