...
if(description)
{
  ...
  script_dependencies("gb_dahua_devices_detect.nasl", "gb_default_credentials_options.nasl");
...
foreach cred(keys(creds)) {
  ...
  req = http_post_put_req(port: port, url: url, data: data, add_headers: make_array("X-Request", "JSON",
