...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script finds the running Snipe Gallery version.");
...
foreach dir( make_list_unique( "/", "/snipegallery", http_cgi_dirs( port:port ) ) ) {
  ...
  if( res =~ "^HTTP/1\.[01] 200" && ">Snipe Gallery" >< res ) {
