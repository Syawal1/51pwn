...
if (banner && "Cisco/SPA" >< banner) {
  ...
  register_and_report_os(os: "Cisco Small Business " + model + " Firmware", cpe: cpe, banner_type: "SIP server banner", port: port, proto: proto, banner: mo[0], desc: "Cisco Small Business VoIP Device Detection (SIP)", runs_key: "unixoide" );
