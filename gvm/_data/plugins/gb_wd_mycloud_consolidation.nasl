...
#
# Western Digital My Cloud Products Detection Consolidation
#
# Authors:
...
if(description)
{
  ...
  script_version("2020-10-21T14:09:45+0000");
  script_tag(name:"last_modification", value:"2020-10-21 14:09:45 +0000 (Wed, 21 Oct 2020)");
...
if( detected_model != "unknown" ) {
  ...
  # nb: Some special handling from gb_wd_mycloud_web_detect.nasl to differ between the various
...
register_and_report_os( os:os_app, cpe:os_cpe, desc:"Western Digital My Cloud / WD Cloud Products Detection Consolidation", runs_key:"unixoide" );
