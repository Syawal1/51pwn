...
if(description)
{
  ...
  script_version("2020-11-02T15:35:31+0000");
  script_tag(name:"last_modification", value:"2020-11-02 15:35:31 +0000 (Mon, 02 Nov 2020)");
...
if(!stat = get_kb_item("Policy/linux//etc/issue/content")){
  value = "Error";
