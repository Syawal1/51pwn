...
if(description)
{
  ...
  script_version("2020-08-04T10:29:28+0000");
  script_tag(name:"last_modification", value:"2020-08-04 10:29:28 +0000 (Tue, 04 Aug 2020)");
  ...
  foreach key (keys(kb_list)){
    ...
    if(umask_line){
      ...
      if(umask_match){
        ...
        if(policy_access_permissions_match_or_stricter(value:umask, set_point:default) != "yes"){
          compliant = "no";
