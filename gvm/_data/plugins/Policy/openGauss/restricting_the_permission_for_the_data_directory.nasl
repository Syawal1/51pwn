...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150329");
  ...
  script_name("openGauss: Restricting the Permission for the data Directory");
...
${GAUSSDATA} is the data directory of the database node.";
default = "none";
test_type = "SSH_Cmd";
