...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150327");
  ...
  script_name("openGauss: Restricting the Permission for the ${GAUSSHOME}/share Directory");
  ...
  script_tag(name:"summary", value:"The ${GAUSSHOME} /share directory stores the shared components of openGauss.
To prevent them from being tampered or damaged, the directory must be
