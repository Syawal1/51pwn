...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150495");
  ...
  script_name("GaussDB Kernel: Enabling the Archiving Mode");
...
solution = "Set archive_mode to on in the postgresql.conf configuration file and restart the
Database.";
default = "none";
test_type = "SQL_Query";
