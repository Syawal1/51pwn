...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://docs.greenbone.net/GSM-Manual/gos-4/en/compliance.html#cpe-based");
  script_xref(name:"URL", value:"https://docs.greenbone.net/GSM-Manual/gos-5/en/compliance-and-special-scans.html#performing-cpe-based-checks");
  script_xref(name:"URL", value:"https://docs.greenbone.net/GSM-Manual/gos-6/en/compliance-and-special-scans.html#performing-cpe-based-checks");
