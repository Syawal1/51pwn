...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.150191");
  script_version("2020-07-29T09:51:47+0000");
  script_tag(name:"last_modification", value:"2020-07-29 09:51:47 +0000 (Wed, 29 Jul 2020)");
  script_tag(name:"creation_date", value:"2020-04-02 17:57:45 +0000 (Thu, 02 Apr 2020)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:S/C:N/I:N/A:N");
  script_tag(name:"qod", value:"97");

  script_name("GaussDB: Access permissions to ${GSDB_DATA}/data");

  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone Networks GmbH");
  script_family("Policy");
  script_dependencies("read_gsdb_data_permissions.nasl");
...
cmd = "stat ${GSDB_DATA}/data";
title = "Access permissions to ${GSDB_DATA}/data";
solution = "chmod PERMISSION ${GSDB_DATA}/data";
test_type = "SSH_Cmd";
...
}else if(get_kb_item("Policy/linux/${GSDB_DATA}/data/stat/ERROR")){
  value = "Error";
  compliant = "incomplete";
  comment = "Could not get information about ${GSDB_DATA}/data";
}else{
  stat = get_kb_item("Policy/linux/${GSDB_DATA}/data/stat");
