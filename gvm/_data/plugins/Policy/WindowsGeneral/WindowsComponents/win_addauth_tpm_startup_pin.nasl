...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.109406");
...
solution = "Set following UI path accordingly: Windows Components/BitLocker Drive Encryption/Operating System Drives/" + title;
type = "HKLM";
