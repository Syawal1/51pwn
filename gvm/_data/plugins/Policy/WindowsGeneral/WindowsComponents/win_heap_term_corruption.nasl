...
if(description)
{
  ...
  script_tag(name:"summary", value:"Disabling heap termination on corruption can allow certain
legacy plug-in applications to function without terminating Explorer immediately, although Explorer
...
solution = "Set following UI path accordingly: Windows Components/File Explorer/" + title;
type = "HKLM";
