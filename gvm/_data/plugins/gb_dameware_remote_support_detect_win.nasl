...
if(description)
{
  ...
  script_version("2020-08-03T14:33:05+0000");
  script_tag(name:"last_modification", value:"2020-08-03 14:33:05 +0000 (Mon, 03 Aug 2020)");
  script_tag(name:"creation_date", value:"2018-11-26 17:23:16 +0100 (Mon, 26 Nov 2018)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_name("DameWare Remote Support Detection (Windows SMB-Login)");
...
foreach key(key_list) {
  foreach item(registry_enum_keys(key:key)) {
    ...
    if(!appName || appName !~ "DameWare Remote Support")
      continue;
