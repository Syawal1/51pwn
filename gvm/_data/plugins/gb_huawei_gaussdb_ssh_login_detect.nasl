...
if(description)
{
  ...
  script_version("2020-10-27T08:45:50+0000");
  script_tag(name:"last_modification", value:"2020-10-27 08:45:50 +0000 (Tue, 27 Oct 2020)");
  ...
  script_name("Huawei GaussDB Detection (SSH-Login)");
...
# accessible.
_bins = ssh_find_file( file_name: "/zengine", useregex: TRUE, regexpar: "$", sock: sock );
if( _bins )
  bins = make_list( bins, _bins );

_bins = ssh_find_file( file_name: "/zsql", useregex: TRUE, regexpar: "$", sock: sock );
if( _bins )
  bins = make_list( bins, _bins );
