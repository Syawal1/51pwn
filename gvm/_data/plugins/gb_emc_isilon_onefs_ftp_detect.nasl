...
if(description)
{
  ...
  script_name("Dell EMC Isilon OneFS Devices Detection (FTP)");

  script_tag(name:"summary", value:"This script performs an FTP based detection of Dell EMC Isilon OneFS devices.");
