...
if(description)
{
  ...
  script_version("2020-10-28T06:31:00+0000");
  script_tag(name:"last_modification", value:"2020-10-28 06:31:00 +0000 (Wed, 28 Oct 2020)");
...
if( osTxt[2] ) {
  ...
  register_and_report_os( os:osTxt[2], banner_type:"Nmap TCP/IP fingerprinting", banner:'\n' + osTxt[0], desc:"Nmap OS Identification (NASL wrapper)", runs_key:runs_key );
}
