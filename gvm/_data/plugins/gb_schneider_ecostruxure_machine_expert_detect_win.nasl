...
if(description)
{
  ...
  script_name("Schneider Electric EcoStruxure Machine Expert - HVAC Detection (Windows SMB-Login)");
...
foreach key(key_list) {
  foreach item(registry_enum_keys(key:key)) {
    ...
    if(!appName || appName !~ "Schneider Electric EcoStruxure[ -~] Machine Expert - HVAC")
      continue;
