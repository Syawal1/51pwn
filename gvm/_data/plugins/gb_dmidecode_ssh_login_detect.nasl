...
if(description)
{
  ...
  script_version("2020-11-04T14:23:35+0000");
  script_tag(name:"last_modification", value:"2020-11-04 14:23:35 +0000 (Wed, 04 Nov 2020)");
...
full_path_list = ssh_find_file( file_name:"/dmidecode", sock:sock, useregex:TRUE, regexpar:"$" );
if( ! full_path_list ) {
