...
if( "AVM FRITZ!WLAN Repeater" >< banner ) {
  register_and_report_os( os:"AVM FRITZ!WLAN Repeater", cpe:"cpe:/o:avm:fritz%21wlan_repeater", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:banner, desc:SCRIPT_DESC, runs_key:"unixoide" );
  exit( 0 );
}
...
if( egrep( pattern:"VxWorks", string:banner, icase:TRUE ) ) {
  register_and_report_os( os:"Wind River VxWorks", cpe:"cpe:/o:windriver:vxworks", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:banner, desc:SCRIPT_DESC, runs_key:"unixoide" );
...
if( egrep( pattern:"^SERVER: Ubuntu", string:banner, icase:TRUE ) ) {
  ...
  if( ! isnull( version[1] ) ) {
    ...
    register_and_report_os( os:"Ubuntu", version:"19.10", cpe:"cpe:/o:canonical:ubuntu_linux", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:banner, desc:SCRIPT_DESC, runs_key:"unixoide" );
  } else if( "Ubuntu/focal" >< banner ) {
    register_and_report_os( os:"Ubuntu", version:"20.04", cpe:"cpe:/o:canonical:ubuntu_linux", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:banner, desc:SCRIPT_DESC, runs_key:"unixoide" );
  } else {
...
if( egrep( pattern:"^Server: Debian", string:banner, icase:TRUE ) ) {
  ...
  if( ! isnull( version[1] ) ) {
    ...
    register_and_report_os( os:"Debian GNU/Linux", version:"10", cpe:"cpe:/o:debian:debian_linux", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:banner, desc:SCRIPT_DESC, runs_key:"unixoide" );
...
if( " iBMC/" >< banner ) {
  register_and_report_os( os:"Huawei iBMC Firmware", cpe:"cpe:/o:huawei:ibmc_firmware", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:banner, desc:SCRIPT_DESC, runs_key:"unixoide" );
  exit( 0 );
}
