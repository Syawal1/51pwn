...
#
# Apache Tomcat Detection (SMB-Login)
#
# Authors:
...
if(description)
{
  ...
  script_version("2020-03-06T08:00:34+0000");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-03-06 08:00:34 +0000 (Fri, 06 Mar 2020)");
  script_tag(name:"creation_date", value:"2012-01-12 13:49:05 +0530 (Thu, 12 Jan 2012)");
  script_name("Apache Tomcat Detection (SMB-Login)");
