...
netflag = 1;
scapePaths = ssh_find_file(file_name:"/netscape/netscape", useregex:TRUE, regexpar:"$", sock:scape_sock);
...
if(netflag == 0)
{
  scapePaths = ssh_find_file(file_name:"/netscape/install.log", useregex:TRUE, regexpar:"$", sock:scape_sock);
  foreach scapeBin (scapePaths) {
