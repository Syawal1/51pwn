...
if(description)
{
  ...
  script_name("Dell EMC Isilon OneFS Devices Detection (SNMP)");

  script_tag(name:"summary", value:"This script performs SNMP based detection of Dell EMC Isilon OneFS devices.");
