...
if (description)
{
  ...
  script_version("2020-06-15T06:29:09+0000");
  script_tag(name:"last_modification", value:"2020-06-15 06:29:09 +0000 (Mon, 15 Jun 2020)");
  ...
  - Cross-Site Scripting (XSS) in template object username (CVE-2020-13964)

  - Cross-Site Scripting (XSS) via malicious XML attachment (CVE-2020-13965)
