...
if(description)
{
  ...
  script_xref(name:"EulerOS-SA", value:"2019-1470");
...
A vulnerability was found in libarchive's handling of 7zip data. A specially crafted 7zip file can cause an integer overflow resulting in memory corruption that can lead to code execution.(CVE-2016-4300)
