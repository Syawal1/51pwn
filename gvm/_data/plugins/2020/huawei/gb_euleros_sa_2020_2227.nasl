...
if(description)
{
  ...
  script_name("Huawei EulerOS: Security Advisory for python-pillow (EulerOS-SA-2020-2227)");
  ...
  'python-pillow' package(s) announced via the EulerOS-SA-2020-2227 advisory.");
