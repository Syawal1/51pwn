...
if(description)
{
  ...
  script_xref(name:"EulerOS-SA", value:"2017-1192");
...
if(release == "EULEROS-2.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tomcat-el-2.2-api", rpm:"tomcat-el-2.2-api~7.0.76~2", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tomcat-jsp-2.2-api", rpm:"tomcat-jsp-2.2-api~7.0.76~2", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"tomcat-servlet-3.0-api", rpm:"tomcat-servlet-3.0-api~7.0.76~2", rls:"EULEROS-2.0SP2"))) {
    report += res;
  }
