...
if(description)
{
  ...
  script_xref(name:"EulerOS-SA", value:"2019-2431");
...
Directory traversal vulnerability in hw/9pfs/9p.c in QEMU (aka Quick Emulator) allows local guest OS administrators to access host files outsi ...
