...
if(description)
{
  ...
  script_xref(name:"EulerOS-SA", value:"2019-2621");
...
An issue was discovered in LibTIFF 4.0.9. There is an int32 overflow in multiply_ms in tools/ppm2tiff.c, which can cause a denial of service (crash) or possibly have unspecified other impact via a crafted image file.(CVE-2018-17100)
