...
if (cpe == "cpe:/o:huawei:ar120-s_firmware")  {
  ...
  if(version =~ "^V200R006C10" || version =~ "^V200R006C12" || version =~ "^V200R006C13" || version =~ "^V200R006C15" || version =~ "^V200R006C16" || version =~ "^V200R006C17" || version =~ "^V200R007C00SPC600" || version =~ "^V200R008C20" || version =~ "^V200R008C30") {
    if (!patch || version_is_less(version: patch, test_version: "V200R009C00SPC300")) {
      report = report_fixed_ver(installed_version: version, installed_patch: patch, fixed_version: "V200R009C00SPC300");
      security_message(port: 0, data: report);
      exit(0);
  ...
  if(version =~ "^V100R001C10SPC200" || version =~ "^V100R001C20SPC100" || version =~ "^V100R001C30" || version =~ "^V500R001C00" || version =~ "^V500R001C20" || version =~ "^V500R001C30" || version =~ "^V500R001C50") {
  ...
  if(version =~ "^V100R003C10" || version =~ "^V100R005C00SPC100" || version =~ "^V500R002C00" || version =~ "^V600R006C00") {
  ...
  if(version =~ "^V100R001C10SPC200" || version =~ "^V100R001C20SPC002T" || version =~ "^V100R001C30B018" || version =~ "^V500R001C00" || version =~ "^V500R001C20" || version =~ "^V500R001C30" || version =~ "^V500R001C50") {
    if (!patch || version_is_less(version: patch, test_version: "V500R001C60SPC600")) {
      report = report_fixed_ver(installed_version: version, installed_patch: patch, fixed_version: "V500R001C60SPC600");
      security_message(port: 0, data: report);
      exit(0);
  ...
  if(version =~ "^V100R001C00SPC200" || version =~ "^V100R001C10SPC200" || version =~ "^V100R001C20SPC070B710" || version =~ "^V100R001C30" || version =~ "^V500R001C00" || version =~ "^V500R001C20" || version =~ "^V500R001C30" || version =~ "^V500R001C50") {
    if (!patch || version_is_less(version: patch, test_version: "V500R001C60SPC600")) {
      report = report_fixed_ver(installed_version: version, installed_patch: patch, fixed_version: "V500R001C60SPC600");
      security_message(port: 0, data: report);
      exit(0);
