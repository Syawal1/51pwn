...
if(description)
{
  ...
  script_version("2020-10-16T09:03:06+0000");
  ...
  script_tag(name:"last_modification", value:"2020-10-16 09:03:06 +0000 (Fri, 16 Oct 2020)");
...
**DISPUTED** An issue was discovered in the efi subsystem in the Linux kernel through 5.1.5. phys_efi_set_virtual_address_map in arch/x86/platfo ...
