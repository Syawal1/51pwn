...
if(description)
{
  ...
  script_name("Huawei Data Communication: Input Validation Vulnerability in Huawei VRP Platform (huawei-sa-20161228-04-vrp)");
  ...
  script_tag(name:"summary", value:"There is an input validation vulnerability in some Huawei devices using VRP.");

  script_tag(name:"insight", value:"There is an input validation vulnerability in some Huawei devices using VRP. Due to the lack of input validation, an attacker may craft a malformed packet and send it to the device using VRP, causing the device to display additional memory data and possibly leading to sensitive information leakage. (Vulnerability ID: HWPSIRT-2016-02011)Huawei has released software updates to fix this vulnerability. This advisory is available in the linked references.");

  script_tag(name:"impact", value:"An attacker can exploit this vulnerability to make the device display additional memory data, possibly leading to sensitive information leakage.");

  script_tag(name:"affected", value:"S12700 versions V200R007C00 V200R008C00

S5700 versions V200R007C00

S7700 versions V200R002C00 V200R005C00SPC300 V200R006C00SPC500 V200R007C00 V200R008C00SPC500

S9700 versions V200R007C00");
