...
if(description)
{
  ...
  script_name("Huawei EulerOS: Security Advisory for python-requests (EulerOS-SA-2020-2201)");
  ...
  'python-requests' package(s) announced via the EulerOS-SA-2020-2201 advisory.");
