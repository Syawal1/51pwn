...
if (description)
{
  ...
  to export subscriber lists and gain all of the information provided by subscribers, view and modify settings,
  along with editing email campaigns and subscriber lists, and modify settings via CSRF.");
