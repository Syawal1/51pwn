...
if (description)
{
  ...
  script_version("2020-05-07T08:59:17+0000");
  script_tag(name:"last_modification", value:"2020-05-07 08:59:17 +0000 (Thu, 07 May 2020)");
  ...
  script_tag(name:"summary", value:"Liferay Portal is prone to multiple remote code execution vulnerabilities
  in the JSON web service.");
