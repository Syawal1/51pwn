...
if(description)
{
  ...
  script_version("2020-11-27T10:22:39+0000");
  script_tag(name:"last_modification", value:"2020-11-27 10:22:39 +0000 (Fri, 27 Nov 2020)");
...
foreach key( key_list ) {
  foreach item( registry_enum_keys( key:key ) ) {
    ...
    if( ! appName || ( appName !~ "Beckhoff TwinCAT [0-9.]+" && appName != "TwinCAT" ) ||
        appName =~ "(Remote Manager|Scope|Type System|BlockDiagram)" )
      continue;
