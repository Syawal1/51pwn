...
if( sysdesc =~ "^HP-UX" ) {
  ...
  if( ! isnull( version[1] ) ) {
    register_and_report_os( os:"HP HP-UX", version:version[1], cpe:"cpe:/o:hp:hp-ux", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  } else {
    register_and_report_os( os:"HP HP-UX", cpe:"cpe:/o:hp:hp-ux", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  }
  exit( 0 );
}
...
if( sysdesc =~ "^SunOS" ) {
  ...
  if( ! isnull( version[1] ) ) {
    register_and_report_os( os:"Sun SunOS", version:version[1], cpe:"cpe:/o:sun:sunos", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  } else {
    register_and_report_os( os:"Sun SunOS", cpe:"cpe:/o:sun:sunos", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  }
  exit( 0 );
}
...
if( "JETDIRECT" >< sysdesc ) {
  ...
  register_and_report_os( os:"HP JetDirect Firmware", cpe:"cpe:/o:hp:jetdirect_firmware", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  exit( 0 );
}

if( "HP ETHERNET MULTI-ENVIRONMENT" >< sysdesc ) {
  register_and_report_os( os:"HP Ethernet Multi-Environment Firmware", cpe:"cpe:/o:hp:ethernet_multi-environment_firmware", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  exit( 0 );
}
...
if( ( sysdesc =~ "^Cisco IOS" || "IOS (tm)" >< sysdesc ) && ( "Cisco IOS XR" >!< sysdesc && "Cisco IOS XE" >!< sysdesc && "IOS-XE" >!< sysdesc ) ) {
  ...
  if( ! isnull( version[1] ) ) {
    register_and_report_os( os:"Cisco IOS", version:version[1], cpe:"cpe:/o:cisco:ios", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
    set_kb_item( name:"cisco_ios/snmp/version", value:version[1] );
    set_kb_item( name:"cisco_ios/detected", value:TRUE );
  } else {
    register_and_report_os( os:"Cisco IOS", cpe:"cpe:/o:cisco:ios", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  }
  exit( 0 );
}
...
if( ( sysdesc =~ "^Cisco IOS" || "IOS (tm)" >< sysdesc ) && "Cisco IOS XR" >!< sysdesc && ( "Cisco IOS XE" >< sysdesc || "IOS-XE" >< sysdesc ) ) {
  ...
  if( ! isnull( version[1] ) ) {
    ...
    register_and_report_os( os:"Cisco IOS XE", version:version[1], cpe:"cpe:/o:cisco:ios_xe", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
    set_kb_item( name:"cisco_ios_xe/snmp/version", value:version[1] );
    set_kb_item( name:"cisco_ios_xe/detected", value:TRUE );
  } else {
    register_and_report_os( os:"Cisco IOS XE", cpe:"cpe:/o:cisco:ios_xe", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  }
  exit( 0 );
}
...
if( "Base Operating System Runtime AIX" >< sysdesc ) {
  ...
  if( ! isnull( version[1] ) ) {
    register_and_report_os( os:"IBM AIX", version:version[1], cpe:"cpe:/o:ibm:aix", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  } else {
    register_and_report_os( os:"IBM AIX", cpe:"cpe:/o:ibm:aix", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  }
  exit( 0 );
}
...
if( "Juniper Networks" >< sysdesc && "JUNOS" >< sysdesc ) {
  ...
  if( ! isnull( version[1] ) ) {
    register_and_report_os( os:"Juniper JunOS", version:version[1], cpe:"cpe:/o:juniper:junos", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  }  else {
    register_and_report_os( os:"Juniper JunOS", cpe:"cpe:/o:juniper:junos", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  }
  exit( 0 );
}
...
if( "OpenVMS" >< sysdesc ) {
  ...
  if( ! isnull( version[1] ) ) {
    register_and_report_os( os:"HP OpenVMS", version:version[1], cpe:"cpe:/o:hp:openvms", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  } else {
    register_and_report_os( os:"HP OpenVMS", cpe:"cpe:/o:hp:openvms", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  }
  exit( 0 );
}
...
if( "Novell NetWare" >< sysdesc ) {
  ...
  if( ! isnull( version[1] ) ) {
    register_and_report_os( os:"Novell NetWare", version:version[1], cpe:"cpe:/o:novell:netware", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  } else {
    register_and_report_os( os:"Novell NetWare", cpe:"cpe:/o:novell:netware", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  }
  exit( 0 );
}
...
if( sysdesc =~ "running IRIX(64)? version" ) {
  ...
  if( ! isnull( version[1] ) ) {
    register_and_report_os( os:"SGI IRIX", version:version[1], cpe:"cpe:/o:sgi:irix", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  } else {
    register_and_report_os( os:"SGI IRIX", cpe:"cpe:/o:sgi:irix", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  }
  exit( 0 );
}
...
if( "SCO OpenServer" >< sysdesc ) {
  ...
  if( ! isnull( version[1] ) ) {
    register_and_report_os( os:"SCO OpenServer", version:version[1], cpe:"cpe:/o:sco:openserver", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  } else {
    register_and_report_os( os:"SCO OpenServer", cpe:"cpe:/o:sco:openserver", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  }
  exit( 0 );
}
...
if( "SCO UnixWare" >< sysdesc ) {
  ...
  if( ! isnull( version[1] ) ) {
    register_and_report_os( os:"SCO UnixWare", version:version[1], cpe:"cpe:/o:sco:unixware", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  } else {
    register_and_report_os( os:"SCO UnixWare", cpe:"cpe:/o:sco:unixware", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  }
  exit( 0 );
}
...
if( "Novell UnixWare" >< sysdesc ) {
  ...
  if( ! isnull( version[1] ) ) {
    register_and_report_os( os:"Novell UnixWare", version:version[1], cpe:"cpe:/o:novell:unixware", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  } else {
    register_and_report_os( os:"Novell UnixWare", cpe:"cpe:/o:novell:unixware", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  }
  exit( 0 );
}
...
if( sysdesc =~ "^Ruckus Wireless ZD[0-9]+" ) {
  register_and_report_os( os:"Ruckus ZoneDirector Firmware", cpe:"cpe:/o:ruckuswireless:zonedirector_firmware", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  exit( 0 );
}
...
if( sysdesc =~ "^DrayTek.+Router Model" || sysdesc =~ "^DrayTek Corporation" || sysdesc =~ "^Linux Draytek " ) {
  register_and_report_os( os:"DrayTek Vigor Firmware", cpe:"cpe:/o:draytek:vigor_firmware", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  exit( 0 );
}

# nb: More detailed OS Detection covered in gb_cambium_cnpilot_snmp_detect.nasl
if( sysdesc =~ "^cnPilot" ) {
  register_and_report_os( os:"Cambium Networks cnPilot Firmware", cpe:"cpe:/o:cambiumnetworks:cnpilot_firmware", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  exit( 0 );
}

if( "Option CloudGate" >< sysdesc ) {
  register_and_report_os( os:"Option CloudGate Firmware", cpe:"cpe:/o:option:cloudgate_firmware", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  exit( 0 );
}
...
if( sysdesc =~ "(Cisco )?Network Analysis Module" &&
  ...
  register_and_report_os( os:"Cisco NAM", cpe:"cpe:/o:cisco:prime_network_analysis_module_firmware", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  exit( 0 );
}
...
if( "ZNID-GPON" >< sysdesc || "Zhone Indoor Network Interface" >< sysdesc ) {
  register_and_report_os( os:"ZHONE ZNID GPON Firmware", cpe:"cpe:/o:dasanzhone:znid_firmware", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  exit( 0 );
}
...
if( sysdesc =~ "S(G|F)[0-9]{3}.*(Stackable Managed|Managed|Smart) Switch$" ) {
  register_and_report_os( os:"Cisco Small Business Switch Firmware", cpe:"cpe:/o:cisco:small_business_switch_firmware", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  exit( 0 );
}
...
if( sysdesc =~ "^SATO " ) {
  register_and_report_os( os:"SATO Printer Firmware", cpe:"cpe:/o:sato:printer_firmware", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  exit( 0 );
}

# nb: More detailed OS Detection covered in gsf/gb_konicaminolta_printer_snmp_detect.nasl
if( sysdesc =~ "^KONICA MINOLTA " ) {
  register_and_report_os( os:"KONICA MINOLTA Printer Firmware", cpe:"cpe:/o:konicaminolta:printer_firmware", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  exit( 0 );
}
...
if( egrep( pattern:"VxWorks", string:sysdesc, icase:TRUE ) ) {
  register_and_report_os( os:"Wind River VxWorks", cpe:"cpe:/o:windriver:vxworks", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  exit( 0 );
}
...
if( egrep( pattern:"^Westermo.*, primary:.*, backup:.*, bootloader:", string:sysdesc, icase:TRUE ) ) {
  register_and_report_os( os:"Westermo WeOS", cpe:"cpe:/o:westermo:weos", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
  exit( 0 );
}
...
if( sysdesc =~ "Linux" && "Cisco IOS" >!< sysdesc ) {
  ...
  if( version[1] ) {
    ...
    if( version[1] =~ "\.h[0-9]+" ) {
      register_and_report_os( os:"Huawei EulerOS", cpe:"cpe:/o:huawei:euleros", banner_type:BANNER_TYPE, port:port, proto:"udp", banner:sysdesc, desc:SCRIPT_DESC, runs_key:"unixoide" );
      exit( 0 );
    }
