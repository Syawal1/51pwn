...
if(description)
{
  ...
  script_version("2020-08-12T11:08:13+0000");
  script_tag(name:"last_modification", value:"2020-08-12 11:08:13 +0000 (Wed, 12 Aug 2020)");
  script_tag(name:"creation_date", value:"2019-04-24 12:50:31 +0200 (Wed, 24 Apr 2019)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_name("Delta Electronics CNCSoft Version Detection (Windows SMB-Login)");
...
foreach key( key_list ) {
  foreach item( registry_enum_keys( key:key ) ) {
    ...
    if( ! appName || "Delta CNC SoftMain" >!< appName ) {
      found = FALSE;
