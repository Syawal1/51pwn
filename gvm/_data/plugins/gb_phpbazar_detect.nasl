...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script finds the running phpBazar version.");
...
foreach dir( make_list_unique( "/", "/phpBazar", "/PHPBazar", http_cgi_dirs( port:port ) ) ) {
  ...
  if( rcvRes =~ "^HTTP/1\.[01] 200" && "Welcome to phpBazar!" >< rcvRes ) {
