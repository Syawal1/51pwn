...
if(description)
{
  ...
  The script logs in via smb, searches for Zoom Client installation path and
  gets version information from executable.");
...
if(version)
{
  ...
  cpe2 = build_cpe(value:version[1], exp:"^([0-9.]+)", base:"cpe:/a:zoom:meetings:");
  if(!cpe2)
