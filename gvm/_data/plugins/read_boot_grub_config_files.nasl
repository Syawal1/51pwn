...
if(description)
{
  ...
  script_version("2020-08-04T09:31:06+0000");
  script_tag(name:"last_modification", value:"2020-08-04 09:31:06 +0000 (Tue, 04 Aug 2020)");
...
grub_cfg_files = ssh_find_file(file_name:"/boot/.*/grub.cfg", sock:sock, useregex:TRUE);
menu_lst_files = ssh_find_file(file_name:"/boot/.*/menu.lst", sock:sock, useregex:TRUE);
user_cfg_files = ssh_find_file(file_name:"/boot/.*/user.cfg", sock:sock, useregex:TRUE);
