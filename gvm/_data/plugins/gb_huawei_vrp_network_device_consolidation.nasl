...
if(description)
{
  ...
  script_version("2020-08-03T10:11:26+0000");
  script_tag(name:"last_modification", value:"2020-08-03 10:11:26 +0000 (Mon, 03 Aug 2020)");
  ...
  script_dependencies("gb_huawei_vrp_network_device_snmp_detect.nasl", "gb_huawei_vrp_network_device_ssh_banner_detect.nasl",
                      "gb_huawei_vrp_network_device_http_detect.nasl", "gb_huawei_vrp_network_device_ssh_login_detect.nasl",
...
register_and_report_os(os: os_name, cpe: os_cpe, desc: "Huawei VRP Detection Consolidation", runs_key: "unixoide");
