...
fsavPaths = ssh_find_file(file_name:"/fsav", useregex:TRUE, regexpar:"$", sock:sock);
...
fsigkPaths = ssh_find_file(file_name:"/fsigk/Makefile", useregex:TRUE, regexpar:"$", sock:sock);
if(fsigkPaths != NULL)
{
