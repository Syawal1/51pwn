...
foreach dir( make_list_unique( "/", "/phpmyadmin", "/phpMyAdmin", "/pma", "/PHPMyAdmin", "/3rdparty/phpMyAdmin", "/3rdparty/phpmyadmin", "/.tools/phpMyAdmin/current", http_cgi_dirs( port:port ) ) ) {
