...
if(description)
{
  ...
  script_version("2020-04-28T05:47:37+0000");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:N");
  script_tag(name:"last_modification", value:"2020-04-28 05:47:37 +0000 (Tue, 28 Apr 2020)");
...
log_message( port:port, data:'The remote HTTPS Server is missing the "preload" attribute in the HSTS header.\n\nHSTS Header:\n\n' + banner );
exit( 0 );
