...
if (description)
{
  ...
  - An XSS vulnerability in FortiManager/FortiAnalyzer could allow privileged guest user accounts and restricted user accounts
  ...
  - A vulnerability in FortiManager/FortiAnalyzer address added page could allow malicious script being injected in the input field. This potentially enables XSS attacks.

  - A client side XSS vulnerability in FortiManager/FortiAnalyzer could allow malicious script being injected in the Web-UI. This potentially enables XSS attacks.");
