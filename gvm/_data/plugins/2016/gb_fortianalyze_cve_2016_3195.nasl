...
1. An XSS vulnerability in FortiManager/FortiAnalyzer could allow privileged guest user accounts and restricted user
accounts to inject malicious script to the application-side or client-side of the appliance web-application.

2. A vulnerability in FortiManager/FortiAnalyzer address added page could allow malicious script being injected
in the input field.

3. A client side XSS vulnerability in FortiManager/FortiAnalyzer could allow malicious script being injected
in the Web-UI.");
