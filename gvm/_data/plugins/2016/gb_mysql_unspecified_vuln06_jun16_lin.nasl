...
if(vers =~ "^5\.6" && version_in_range(version:vers, test_version:"5.6", test_version2:"5.6.19")) {
  report = report_fixed_ver(installed_version:vers, vulnerable_range:"5.6 - 5.6.19");
