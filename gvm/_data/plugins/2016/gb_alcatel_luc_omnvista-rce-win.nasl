...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw is due to the fact that determined ORBs are exposed and they can be
  ...
  script_tag(name:"solution", value:"The vendor position is to refer to the technical guidelines of the product
  security deployment to mitigate this issue, which means applying proper firewall rules to prevent unauthorised
  clients to connect to the Omnivista server.");
