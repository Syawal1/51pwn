...
req = http_post_put_req( port:port, url:"/system/sessions", data:data, accept_header:'application/json', add_headers: make_array( "Content-Type", "application/json","Origin","http://" + host ) );
