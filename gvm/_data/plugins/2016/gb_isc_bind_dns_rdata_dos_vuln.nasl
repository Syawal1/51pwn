...
else if(version_in_range(version:version, test_version:"9.4.ESV", test_version2:"9.4.ESV.R5.P1"))
{
  fix ="9.6-ESV-R8";
  VULN = TRUE;
}
...
else if(version_in_range(version:version, test_version:"9.6-ESV", test_version2:"9.6.ESV.R7.P3"))
{
  fix ="9.6-ESV-R7-P4";
  VULN = TRUE;
}
