...
if( "InstantiateTransformer: Constructor threw an exception" >< buf ) {
  report = "It was possible to execute a command on the remot host by sending a special crafted java object to: " + http_report_vuln_url( port:port, url:url, url_only:TRUE );
