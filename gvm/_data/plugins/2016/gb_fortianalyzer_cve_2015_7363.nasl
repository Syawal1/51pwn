...
if (description)
{
  ...
  script_tag(name:"summary", value:"FortiAnalyzer is prone to an XSS vulnerability.");

  script_tag(name:"insight", value:"A cross-site-scripting vulnerability in FortiAnalyzer in advanced settings
