...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://kb.isc.org/docs/aa-01317");
...
if(version_in_range(version:version, test_version:"9.0", test_version2:"9.9.8"))
{
  fix = "9.9.8-P2";
  VULN = TRUE;
}

else if(version_in_range(version:version, test_version:"9.10.0", test_version2:"9.10.3"))
{
  fix = "9.10.3-P2";
  VULN = TRUE;
}
