...
if (description)
{
  ...
  script_version("2020-03-18T08:57:05+0000");
  script_tag(name:"last_modification", value:"2020-03-18 08:57:05 +0000 (Wed, 18 Mar 2020)");
  ...
  script_tag(name:"summary", value:"Barracuda Load Balancer is prone to a remote code exectuion vulnerability.");
