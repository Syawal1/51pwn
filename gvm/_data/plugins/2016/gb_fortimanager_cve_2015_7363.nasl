...
if (description)
{
  ...
  script_tag(name:"summary", value:"FortiManager is prone to an XSS vulnerability.");

  script_tag(name:"insight", value:"A cross-site-scripting vulnerability in FortiManager in advanced settings
