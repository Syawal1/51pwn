...
if(description)
{
  ...
  script_version("2020-08-11T13:29:33+0000");
  script_tag(name:"last_modification", value:"2020-08-11 13:29:33 +0000 (Tue, 11 Aug 2020)");
...
if( ! isnull( enable_log ) && "yes" >!< enable_log )
  exit( 0 );
