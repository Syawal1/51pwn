...
if (description)
{
  ...
  script_tag(name:"last_modification", value:"2020-11-10 09:13:10 +0000 (Tue, 10 Nov 2020)");
...
register_and_report_os(os: os_name, cpe: os_cpe, desc: "Xerox Printer Detection Consolidation", runs_key: "unixoide");
