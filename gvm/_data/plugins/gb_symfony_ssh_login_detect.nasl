...
if(description)
{
  ...
  script_version("2020-11-23T14:22:51+0000");
  script_tag(name:"last_modification", value:"2020-11-23 14:22:51 +0000 (Mon, 23 Nov 2020)");
  ...
  script_tag(name:"summary", value:"SSH login based detection of a Sensiolabs Symfony installation.");
...
path_list = ssh_find_file( file_name:"/Symfony/Component/HttpKernel/Kernel.php", useregex:TRUE, regexpar:"$", sock:sock );
if( ! path_list ) {
