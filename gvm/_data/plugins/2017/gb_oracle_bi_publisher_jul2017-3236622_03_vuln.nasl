...
if(description)
{
  ...
  script_name("Oracle BI Publisher Multiple Unspecified Vulnerabilities - 03 (cpujul2017)");
  ...
  script_tag(name:"impact", value:"Successful exploitation of this vulnerability will allow remote attackers to
  have an impact on confidentiality and integrity.");

  script_tag(name:"affected", value:"Oracle BI Publisher versions 11.1.1.7.0, 11.1.1.9.0, 12.2.1.1.0 and 12.2.1.2.0.");
