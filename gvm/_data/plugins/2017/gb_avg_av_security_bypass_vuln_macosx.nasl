...
if(description)
{
  ...
  script_tag(name:"qod_type", value:"executable_version_unreliable"); # Note: The issue was fixed in engine version 4668 in October 2016, and was confirmed again in version 17.2, virus database 170626-4. qod is reduced because nvt developed considering main antivirus version not the scan engine version.
