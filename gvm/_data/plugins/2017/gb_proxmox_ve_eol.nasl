...
if(description)
{
  ...
  script_tag(name:"summary", value:"The Proxmox Virtual Environment version on the remote host has
  reached the end of life and should not be used anymore.");

  script_tag(name:"impact", value:"An end of life version of Proxmox Virtual Environment is not
  ...
  script_tag(name:"solution", value:"Update the Proxmox Virtual Environment version on the remote
