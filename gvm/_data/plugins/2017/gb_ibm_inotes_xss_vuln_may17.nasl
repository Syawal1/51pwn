...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw is due to an input validation error in the Web UI.");
  ...
  script_tag(name:"solution", value:"Upgrade to IBM iNotes 9.0.1 FP8 IF2, 8.5.3 FP6 IF4 or later.");
...
if(version_in_range(version:version, test_version:"9.0", test_version2:"9.0.1.7"))
