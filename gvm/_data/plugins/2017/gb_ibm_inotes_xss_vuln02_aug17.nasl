...
if(description)
{
  ...
  script_tag(name:"summary", value:"IBM iNotes is prone to cross site scripting vulnerability.");
  ...
  prior to 8.5.3 Fix Pack 6 Interim Fix 18, 9.0 and 9.0.1 prior to 9.0.1 Fix Pack 8 Interim Fix 3.");
