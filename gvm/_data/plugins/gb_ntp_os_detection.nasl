...
if(description)
{
  ...
  script_version("2020-11-16T07:39:40+0000");
  script_tag(name:"last_modification", value:"2020-11-16 07:39:40 +0000 (Mon, 16 Nov 2020)");
...
if( "linux" >< banner_lo ) {
  ...
  # Linux/3.2.8-1-ARCH
    ...
    register_and_report_os( os:"Arch Linux", cpe:"cpe:/o:archlinux:arch_linux", banner_type:BANNER_TYPE, banner:banner, port:port, proto:"udp", desc:SCRIPT_DESC, runs_key:"unixoide" );
  }
...
# "VMkernel is a POSIX-like operating system developed by VMware."
  ...
  register_and_report_os( os:"Cisco IOS", cpe:"cpe:/o:cisco:ios", banner_type:BANNER_TYPE, banner:banner, port:port, proto:"udp", desc:SCRIPT_DESC, runs_key:"unixoide" );
}
