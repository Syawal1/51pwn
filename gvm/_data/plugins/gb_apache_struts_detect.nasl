...
if(description)
{
  ...
  script_tag(name:"summary", value:"The script detects the version of Apache Struts.");
...
asPort = http_get_port( default:8080 );

foreach dir( make_list_unique("/", "/struts", http_cgi_dirs( port:asPort ) ) )
{
  install = dir;
  if( dir == "/" ) dir = "";
