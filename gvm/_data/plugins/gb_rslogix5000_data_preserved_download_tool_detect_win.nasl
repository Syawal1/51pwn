...
if(description)
{
  ...
  script_name("Rockwell Automation RSLogix5000 Data Preserved Download ToolDetection (Windows SMB-Login)");
...
foreach key(key_list) {
  foreach item(registry_enum_keys(key:key)) {
    ...
    if(!appName || appName !~ "RSLogix5000 Data Preserved Download Tool")
      continue;
