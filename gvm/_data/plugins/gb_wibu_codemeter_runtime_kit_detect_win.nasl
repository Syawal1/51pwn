...
if(description)
{
  ...
  script_name("WIBU-SYSTEMS CodeMeter Runtime Detection (SMB-Login)");
  ...
  script_tag(name:"summary", value:"Checks whether WIBU-SYSTEMS CodeMeter Runtime is
...
foreach key( key_list ) {
  foreach item( registry_enum_keys( key:key ) ) {
    ...
    if( ! appName || appName !~ "CodeMeter Runtime" )
      continue;
