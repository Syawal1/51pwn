...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.ietf.org/rfc/rfc7323.txt");
  ...
  script_tag(name:"insight", value:"The remote host implements TCP timestamps, as defined by RFC1323/RFC7323.");
