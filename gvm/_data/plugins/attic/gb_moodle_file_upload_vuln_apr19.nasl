...
if(description)
{
  ...
  This VT has been deprecated since this CVE has been withdrawn since further
  investigation showed that it was not a security issue.");
  ...
  Note: No vendor fix will be provided since further investigation showed that it was not a security issue.");
