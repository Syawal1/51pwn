...
if(description)
{
  ...
  script_tag(name:"summary", value:"This host is installed with Fortinet FortiMail and is prone to a cross-site scripting vulnerability.

  This VT has been replaced by VT 'FortiMail Stored Cross-Site Scripting Vulnerability - June 2015' (OID: 1.3.6.1.4.1.25623.1.0.805646).");
