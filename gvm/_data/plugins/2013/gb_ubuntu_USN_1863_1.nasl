...
if(release == "UBUNTU12.10")
{
  ...
  if ((res = isdpkgvuln(pkg:"libxrender1", ver:"1:0.9.7-1ubuntu0.12.10.1", rls:"UBUNTU12.10")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
...
if(release == "UBUNTU13.04")
{
  ...
  if ((res = isdpkgvuln(pkg:"libxrender1", ver:"1:0.9.7-1ubuntu0.13.04.1", rls:"UBUNTU13.04")) != NULL)
  {
    security_message(data:res);
    exit(0);
  }
