...
if(description)
{
  ...
  script_name("VMware ESXi/ESX updates address multiple vulnerabilities (VMSA-2013-0012)");
  ...
  script_tag(name:"summary", value:"VMware has updated ESXi and ESX to address multiple security vulnerabilities.");
