...
if(vers =~ "^11\.0") {
  if(version_in_range(version:vers, test_version:"11.0.0", test_version2:"11.0.04"))
  {
    report = report_fixed_ver(installed_version:vers, vulnerable_range:"11.0.0 - 11.0.04");
