...
if(description)
{
  ...
  script_tag(name:"summary", value:"This script finds the Uebimiau Webmail version.");
...
foreach dir( make_list_unique( "/", "/uebimiau", "/webmail", http_cgi_dirs( port:port ) ) ) {
  ...
  if( rcvRes =~ "^HTTP/1\.[01] 200" && "Uebimiau Webmail" >< rcvRes ) {
